...
\begin{description*}
	\item[Languages:]
	Scala, Java, C\#, Python, Go, shell, Haskell, HTML/CSS, SQL, \LaTeX, SML
	\item[Tools:]
...
\begin{itemize}
	...
	\headerrow
		...
		{\emph{}}
	\begin{itemize*}
		\item Scala project with the Play framwork
		\item Backend in PostgreSQL with the Slick Functional Relational Mapping library
                ...
                \item Live at \url{http://ssmupowerlifting.jonfk.ca}
	\end{itemize*}
        % End Project
	...
	\begin{itemize*}
		...
		\item Backend in Spray with eclipse aether library to crawl the Maven Repository
                \item Front-end made using Bootstrap, JQuery and AngularJS
	...
	\item
	\headerrow
		{\textbf{Purely Functional Dynamic language}}
	...
	\begin{itemize*}
		\item Lexer and parser are hand written in Go.
                \item Concurrent lexer similar to the Go lexer
                \item Recursive descent parser done manually
